# Exemplo disponível em: https://github.com/arrudamichel/tkinter-python-exemplos/blob/master/17-exemplo.py
from tkinter import *
...
class Janela:
    ...
    def __init__(self, instancia_de_Tk):
        ...
        label3 = Label(frame3, text="Altura(cm):");
        label3.pack()
        self.spin_altura = Spinbox(frame3, from_=0, to=150);
        self.spin_altura.pack()

        self.peso = IntVar()
        label3 = Label(frame3, text="Peso(kg):");
        label3.pack()
        self.spin_peso = Spinbox(frame3, from_=0, to=150);
        self.spin_peso.pack()
